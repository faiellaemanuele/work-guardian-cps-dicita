...
WINDOW_TITLE: str = "WORK GUARDIAN - Preparazione al volo"

SCENARIO_WINDOW_TITLE: str = "WORK GUARDIAN - Scelta dello scenario"

VIDEO_WINDOW_TITLE: str = "WORK GUARDIAN - Volo e supervisione"
